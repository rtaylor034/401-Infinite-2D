...
//     version 1.4.3
//     from Assets/Framework/Inputs.inputactions
//
...
public partial class @Inputs : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_Test_Testprompt = m_Test.FindAction("Testprompt", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Test_Testprompt;
    public struct TestActions
    {
        private @Inputs m_Wrapper;
        public TestActions(@Inputs wrapper) { m_Wrapper = wrapper; }
        public InputAction @Testprompt => m_Wrapper.m_Test_Testprompt;
        ...
        public void SetCallbacks(ITestActions instance)
        {
            ...
            {
                @Testprompt.started -= m_Wrapper.m_TestActionsCallbackInterface.OnTestprompt;
                @Testprompt.performed -= m_Wrapper.m_TestActionsCallbackInterface.OnTestprompt;
                @Testprompt.canceled -= m_Wrapper.m_TestActionsCallbackInterface.OnTestprompt;
            }
            m_Wrapper.m_TestActionsCallbackInterface = instance;
            if (instance != null)
            {
                @Testprompt.started += instance.OnTestprompt;
                @Testprompt.performed += instance.OnTestprompt;
                @Testprompt.canceled += instance.OnTestprompt;
            }
        }
    }
    ...
    {
        void OnTestprompt(InputAction.CallbackContext context);
    }
}
